      ...
      <div class="row">
        ...
        <div class="text-center my-5">
            <div class="text-align-center">
                ...
                <a href="#" class="btn btn-success btn-lg rounded-pill" style="background-color:#0fcc08; padding-left: 50px; padding-right: 50px;border:none;">Lihat Status <br> Kenaikan Pangkat</a>
            </div>
        </div>
