          ...
          <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col">
                      <h4 class="mb-1 mt-4" style="color:#012970;"><strong>Simulasi PAK Kegiatan Penunjang Tri Dharma PT</strong></h4>
                        <div class="row justify-content-between">
                            ...
                            <div class="col-5 text-end">
                                    ...
                                    <a href="{{ route('penunjang_tri_dharma_pt_tambah') }}" class="mb-0 mt-0 btn btn-primary" style="background-color:#012970 ">+ Tambah</a>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex justify-content-center ">
                                          <form action="{{ route('penunjang_tri_dharma_pt_destroy', $data->slug) }}" method="post">
                                              @method('delete')
                                              @csrf
                                    ...
                                    <td class="text-center"><a href="{{ route('penunjang_tri_dharma_pt_detail', $data->slug)  }}" class="text-decoration:none" style="color:rgb(0, 0, 0)">{{ $data->kegiatan }}</a></td>
