          ...
          <div class="card">
            <div class="card-body">
                ...
                <div class="col-lg text-center mt-3">
                    <a href="{{ route('penelitian') }}" class="btn btn-lg btn-warning rounded-pill" style="color:#012970;padding-left: 25px; padding-right: 25px;">Kembali</a>
                    
                    <form class="inline-form" action="{{ route('penelitian_destroy', $record->slug) }}" method="post">
                        @method('delete')
                        @csrf
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <!-- Vertical Form -->
                    <form class="my-3" action="{{ route('penelitian_edit_store', $record->slug) }}" method="post" enctype="multipart/form-data">
                        @csrf
